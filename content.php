...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    if (!is_single() && !is_page()) { ?>
        <h2 class='entry-title'><a href="<?php the_permalink(); ?>"
                                   title="<?php printf(smt_translate('permalink'), the_title_attribute('echo=0')); ?>"><?php the_title(); ?></a>
        </h2>
    <?php } else { ?>
    ...
    <?php if (!is_single()) : ?>
        ...
        <div class="entry-summary">
            <?php
            if (smt_getOption('layout', 'cuttxton')) {
            ...
            <div class="entry-meta">
                ...
                <?php //echo the_author_posts_link();?><!--</span></span>,-->
                <!--				--><?php //if(comments_open( get_the_ID() )) { ?>
                <!--					<span class='post-comments'>-->
                <?php //comments_popup_link( smt_translate( 'noresponses' ), smt_translate( 'oneresponse' ), smt_translate( 'multiresponse' ) ); ?><!--</span>,-->
